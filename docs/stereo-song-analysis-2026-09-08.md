...
90.39% coverage. The fix is included in
[alpha.21](https://github.com/Majkey25/TuneItAll/releases/tag/v0.3.0-alpha.21);
see the [release record](store/2026-09-08-alpha21-release.md) for Play status.
